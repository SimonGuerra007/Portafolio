...
const ModalDownloadCv = ({
  ...
  return (
    <div
      className={`h-screen w-full bg-black/60 flex justify-center items-center fixed top-0  z-[7500] ${modalDownload ? 'visible' : 'invisible'} `}
    >
      <div
        className={`w-[100%] h-[50%] sm:w-[60%] sm:h-[50%] p-5 rounded-[20px] flex flex-col justify-center items-center gap-[30px] transition-all fixed ${modalDownload ? 'sm:left-[20%] left-0' : 'left-[-200%]'} ${
          darkMode
